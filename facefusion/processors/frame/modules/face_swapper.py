...
MODELS : ModelSet =\
{
	'blendswap_256':
	{
		...
		'path': resolve_relative_path('../models/blendswap_256.onnx'),
		'template': 'ffhq_512',
		'size': (512, 256),
		'mean': [ 0.0, 0.0, 0.0 ],
	...
	'inswapper_128':
	{
		...
		'path': resolve_relative_path('../models/inswapper_128.onnx'),
	...
	'simswap_256':
	{
		...
		'path': resolve_relative_path('../models/simswap_256.onnx'),
	...
	'simswap_512_unofficial':
	{
		...
		'path': resolve_relative_path('../models/simswap_512_unofficial.onnx'),
		'template': 'arcface_112_v1',
		'size': (112, 512),
		'mean': [ 0.0, 0.0, 0.0 ],
		'standard_deviation': [ 1.0, 1.0, 1.0 ]
...
def swap_face(source_face : Face, target_face : Face, temp_frame : Frame) -> Frame:
	...
	if 'box' in facefusion.globals.face_mask_types:
		r = create_static_box_mask(crop_frame.shape[:2][::-1], facefusion.globals.face_mask_blur, facefusion.globals.face_mask_padding)
		crop_mask_list.append(r)
