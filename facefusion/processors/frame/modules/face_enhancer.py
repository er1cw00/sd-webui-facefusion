...
MODELS : ModelSet =\
{
	...
	'gfpgan_1.2':
	{
		...
		'path': resolve_relative_path('../models/gfpgan_1.2.onnx'),
		'template': 'ffhq_512',
		'size': (512, 512)
	},
	'gfpgan_1.3':
	{
		...
		'path': resolve_relative_path('../models/gfpgan_1.3.onnx'),
		'template': 'ffhq_512',
		'size': (512, 512)
	},
	'gfpgan_1.4':
	{
		...
		'path': resolve_relative_path('../models/gfpgan_1.4.onnx'),
		'template': 'ffhq_512',
		'size': (512, 512)
	},
	'gpen_bfr_256':
	{
		...
		'path': resolve_relative_path('../models/gpen_bfr_256.onnx'),
	...
	'gpen_bfr_512':
	{
		...
		'path': resolve_relative_path('../models/gpen_bfr_512.onnx'),
		'template': 'ffhq_512',
		'size': (512, 512)
	},
	'restoreformer':
	{
		...
		'path': resolve_relative_path('../models/restoreformer.onnx'),
		'template': 'ffhq_512',
		'size': (512, 512)
	}
}
