...
MODELS : ModelSet =\
{
	'face_detector_retinaface':
	{
		...
		'path': resolve_relative_path('../models/retinaface_10g.onnx')
	},
	'face_detector_yunet':
	{
		'url': 'https://github.com/facefusion/facefusion-assets/releases/download/models/yunet_2023mar.onnx',
		'path': resolve_relative_path('../models/yunet_2023mar.onnx')
	},
	...
	'face_recognizer_arcface_simswap':
	{
		...
		'path': resolve_relative_path('../models/arcface_simswap.onnx')
	},
	'gender_age':
	{
